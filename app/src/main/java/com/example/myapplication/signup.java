...
import com.example.myapplication.model.RegisterAdmin;
...
//        databaseReference = firebaseDatabase.getReference("RsgisterAdmin");
                                                        ...
                                                        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                if (snapshot.child(st).exists()){
                                                                    ...
                                                                    RegisterAdmin registerAdmin = new RegisterAdmin(name,email,contact,city,password);
                                                                    databaseReference.child(st).setValue(registerAdmin);
